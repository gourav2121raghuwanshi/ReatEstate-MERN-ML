    ...
    <main className='page-shell'>
      <div className='glass-panel-strong p-6 sm:p-8'>
        <div className='max-w-3xl space-y-3'>
          ...
          <h1 className='section-heading'>Create a listing with a more polished presentation</h1>
          <p className='section-copy'>
            Add the same listing information as before, now in a cleaner publishing layout designed
            for real estate teams and independent sellers alike.
          </p>
        </div>
            ...
            <div className='grid gap-5'>
              ...
              <div className='grid gap-4 sm:grid-cols-2'>
                ...
                <div>
                  ...
                  <input onChange={handleChange} value={formData.area} id='area' type='number' min='1' max='5000000000' required className='field-shell' />
                </div>
                <div>
                  <label htmlFor='regularPrice' className='field-label'>Regular price</label>
                  <input id='regularPrice' onChange={handleChange} value={formData.regularPrice} type='number' min='1500' max='50000000' required className='field-shell' />
                </div>
                <div>
            ...
            <div className='space-y-5'>
              <div>
                ...
                <p className='text-sm leading-7 text-[color:var(--muted)]'>
                  The first image becomes the cover photo. Upload up to 6 images.
                </p>
              </div>
                  ...
                  formData.imageUrls.map((url, index) => (
                    <div className='glass-panel flex items-center gap-4 p-3' key={url}>
                      <div className='relative'>
                        <img src={url} alt='listing' loading='lazy' className='h-24 w-24 rounded-[18px] object-cover sm:h-28 sm:w-28' />
                        <button
                          onClick={(e) => {
